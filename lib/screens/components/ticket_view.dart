              ...
              child: Column(
                children: [
                  Row(
                          ...
                          child: LayoutBuilder(
                            builder: (BuildContext buildContext, BoxConstraints boxConstrains) {
                              return Flex(
                                ...
                                children: List.generate((boxConstrains.constrainWidth()/6).floor(), (index) => const SizedBox(
                                  height:1,
                                  width: 3,
                    ...
                    const  RoundShape(),
                    const Spacer(),
                      Text("LND",style: Styles.textStyle.copyWith(color: Colors.white)),
                    ],
                  ),
                  const Gap(3),
                  Row(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        children: [
                          Text("14 Feb", style: Styles.headLineStyle3.copyWith(color:Colors.white)),
                          Text("Date", style: Styles.headLineStyle4.copyWith(color: Colors.white))
                        ],
                      ),
                      Column(
                        children: [
                          Text("20H:40M", style: Styles.headLineStyle3.copyWith(color:Colors.white)),
                          Text("Departure Time", style: Styles.headLineStyle4.copyWith(color: Colors.white))
                        ],
                      ),
                      Column(
                        children: [
                          Text("101", style: Styles.headLineStyle3.copyWith(color:Colors.white)),
